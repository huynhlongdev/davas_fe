...
export default function Hero({ data }) {
  const { counters, countdown, buttons, address, title, description } = data;
  ...
  return (
    <section className="relative pt-[72px] bg-white overflow-hidden flex flex-col">
      ...
      {/* Content */}
      <div className="hero-i max-w-[1360px] mx-auto px-4 py-[72px] pb-16 w-full relative z-10 grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 items-center">
        <div className="">
          {/* Badge */}
          {address && (
